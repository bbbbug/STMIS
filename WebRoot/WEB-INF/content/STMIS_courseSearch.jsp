...
<html>
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-17" data-genuitec-path="/STMIS/WebRoot/index.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-22" data-genuitec-path="/STMIS/WebRoot/WEB-INF/content/STMIS_courseSearch.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-22" data-genuitec-path="/STMIS20190919/WebRoot/WEB-INF/content/STMIS_courseSearch.jsp">
		<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-17" data-genuitec-path="/STMIS/WebRoot/index.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-22" data-genuitec-path="/STMIS/WebRoot/WEB-INF/content/STMIS_courseSearch.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-22" data-genuitec-path="/STMIS20190919/WebRoot/WEB-INF/content/STMIS_courseSearch.jsp">
			<div class="index_nav">
				...
				<ul class="nav nav-pills text-center">
					...
					<!-- <li role="presentation">
						<a href="course/goto404" class="text-muted">社区</a>
					</li>
					<li role="presentation">
