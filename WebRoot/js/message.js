    ...
    var api = {
        ...
        bellDraw: function () {
            var bellHtml = "<span data-type='1' class='message-bell-btn' "+ (option.msgUnReadData > 0?("title='"+ option.msgUnReadData + "条新消息'"):"") +">" +
                "<i class='fa fa-bell-o '></i>"+ (option.msgUnReadData > 0?"<span class=''></span>":"") +"</span>" +
        ...
        contentListDraw: function(type) {
            ...
            var div = "<div class='message-frame-header'><span style='height: 40px;line-height: 40px;text-align: center;width: 50px;    display: inline-block;'>"+ (type==1?"消息":"提醒") +"</span></div>"+
            ...
            if (type == 1) {
                ...
                if (option.noticeData && option.noticeData.length > 0) {
                    ...
                    div += "<div class='message-none-msg'>本季度快结束了哟！！！您的学分未达标</div>";
                }
                div += "</div>";
